...
def draw_main_menu(i):
    ...
    menu_image = pygame.image.load(os.path.join('images', menu_address))
...
def draw_opening(i):
    op_address = 'launching/op' + str(i) + '-min.png'
    op_image = pygame.image.load(os.path.join('images', op_address))
